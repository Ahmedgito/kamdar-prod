...
import bg from '../../assets/your-section4-bg.png'; // Update with your actual image
...
const Section4 = () => (
  ...
  >
    ...
    <div className="absolute top-0 left-0 z-10 flex flex-col items-start p-8 md:p-12">
      <h1 className="text-white text-3xl md:text-5xl font-light leading-tight mb-6" style={{ fontFamily: 'Luxerie, sans-serif' }}>
